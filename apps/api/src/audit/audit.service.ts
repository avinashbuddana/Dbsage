...
export enum AuditEvent {
  ...
  DatasourceSpecChatRequested = 'DATASOURCE_SPEC_CHAT_REQUESTED',
  DatasourceSpecAnalysisQueued = 'DATASOURCE_SPEC_ANALYSIS_QUEUED',
  DatasourceSpecAnalysisCompleted = 'DATASOURCE_SPEC_ANALYSIS_COMPLETED',
  DatasourceSpecAnalysisFailed = 'DATASOURCE_SPEC_ANALYSIS_FAILED',
